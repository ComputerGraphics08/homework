...
const mercuryMaterial = new THREE.MeshStandardMaterial({ color: 0xa6a6a6, map: mercuryTexture, roughness: 0.9, metalness: 0.2 });
const venusMaterial = new THREE.MeshStandardMaterial({ color: 0xe39e1c, map: venusTexture, roughness: 0.9, metalness: 0.2 });
const earthMaterial = new THREE.MeshStandardMaterial({ color: 0x3498db, map: earthTexture, roughness: 0.9, metalness: 0.2 });
const marsMaterial = new THREE.MeshStandardMaterial({ color: 0xc0392b, map: marsTexture, roughness: 0.9, metalness: 0.2 });
...
function setupControls() {
    ...
    folder1.add(controls.folder1Params, 'rotationSpeed', 0, 0.1);
    folder1.add(controls.folder1Params, 'orbitSpeed', 0, 0.1);
    folder1.open();

    const folder2 = gui.addFolder('Venus');
    folder2.add(controls.folder2Params, 'rotationSpeed', 0, 0.1);
    folder2.add(controls.folder2Params, 'orbitSpeed', 0, 0.1);
    folder2.open();

    const folder3 = gui.addFolder('Earth');
    folder3.add(controls.folder3Params, 'rotationSpeed', 0, 0.1);
    folder3.add(controls.folder3Params, 'orbitSpeed', 0, 0.1);
    folder3.open();

    const folder4 = gui.addFolder('Mars');
    folder4.add(controls.folder4Params, 'rotationSpeed', 0, 0.1);
    folder4.add(controls.folder4Params, 'orbitSpeed', 0, 0.1);
    folder4.open();
